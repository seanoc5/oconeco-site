...
title: "Tools"
slug: "tools"
description: "The FAND working prototypes and live balance-sheet exhibits, opened directly — badged by production status."
sectionContext: "Interactive exhibits behind the FAND numbers. Every dollar figure carries an honesty badge; subnational figures are provisional."
---

These are working prototypes, not polished apps — opened directly, not embedded. Every dollar figure carries its honesty badge: **Production** is trustworthy at standing ruling and publishable without qualification; **Experimental** subnational figures are provisional, with the watermark traveling with every export; **Prototype** is ordinal / Q-score only. The same balance-sheet identity runs at every scale shown here — the point is to demonstrate that, not to rank places.
