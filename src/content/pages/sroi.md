---
title: "FRoI"
rawTitle: "FRoI :: Oconeco"
slug: "sroi"
sourceUrl: "https://oconeco.webnode.page/sroi/"
---

The Future Return on Investment (FRoI) assigns ***future*** values to streams of services in and beyond GAAP. It then engages stakeholders in deciding probability or speed of change in P's & Q's that matter to the task at hand--or agreeing what counts. Workspace discussion thus considers whether transition matters, given stakeholder 'exit strategies'. Probabilities are higher If stakeholders see the task resonating with economic theories of [convergence](https://www.weforum.org/agenda/2018/02/the-future-of-economic-convergence/) and a [Law of One Price](https://www.researchgate.net/publication/331600509_Time_Arbitrage_and_the_Law_of_One_Price_The_Case_for_a_Paradigm_Shift) (LOP). FRoI will then be higher than an RoI based on past performance yet below one based on [conventional shadow pricing](https://www.thoughtco.com/the-many-definitions-of-shadow-price-1147165). Collecting relevant information is then about ensuring a workspace considers all stakeholder views of probabilities and speed of change, as well as the prospective allocation of the return. The task is then setting & monitoring performance.

***Scroll down for more***

## [Agreeing what counts](../getting-agreement-on-priorities/index.html)
...
**[Collecting relevant information](../collecting-relevant-information/index.html)**  
...
**[Setting & monitoring performance](../setting-monitoring-performance-goals/index.html)**  
