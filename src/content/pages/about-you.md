---
title: "Adding value"
rawTitle: "Adding value :: Oconeco"
slug: "about-you"
sourceUrl: "https://oconeco.webnode.page/about-you/"
---

OconEco workspaces are structured to promote creative ideation, as psychologists use the term (see [here](https://www.researchgate.net/publication/325181921_Specificity_and_Abstraction_of_Examples_Opposite_Effects_on_Fixation_for_Creative_Ideation), for example). Designating Scale(s) and Procedures for a Workspace mitigates [Divergent Thinking](https://www.teachthought.com/critical-thinking/3-modes-of-thought-divergent-convergent-thinking/). Suggesting a novel approach to stakeholder Perspectives and defining the Task(s) promotes [Lateral Thinking](https://www.teachthought.com/critical-thinking/3-modes-of-thought-divergent-convergent-thinking/). 
...
## [Perspectives](../procedures/index.html)

There are many useful references on stakeholder engagement (e.g., [here](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4242886/)). However, we give added attention to[ Perspectives](../procedures/index.html) often missing when workspaces begin yet present in those that make it to the client's work routine. For example, all should agree households are ultimate owners of wealth, broadly defined; and contracts, social and legal, are imperfect ways of passing them the income ([FRoI](../sroi/index.html) in our model) from productive assets. Yet few stakeholder engagement processes have a household representative; advocacy groups and local authorities often claim that role. Similarly, innovation requires patient capital, investors after more than short-term profits; recognizing and valuing 'spillovers' that benefit not only transactional partners but also households as ultimate owners of wealth.. 

More on [Perspectives](../procedures/index.html)
...
More on [Tasks](../tasks/index.html)  

## [Procedures](../processes/index.html)
...
More on [Procedures](../processes/index.html)

## [Scale(s)](../scales/index.html) 

We use this term for rungs in the abstraction-specificity ladder we all traverse in creative ideation tasks (as explained by others, say [here](https://www.researchgate.net/publication/325181921_Specificity_and_Abstraction_of_Examples_Opposite_Effects_on_Fixation_for_Creative_Ideation)). Stakeholders tend to be "fluent" at different rungs of the abstraction ladder. Scales triangulate objective knowledge at prescribed intersections of Who & What, Where, When concept hierarchies in FIND & M-LA. This invites discussion of whether, and if so How & Why, Scale matters. For practical reasons, we recommend anchoring a task at the County level.We offer pre-processed evidence and procedures at each scale. What gets tricky on lower rungs, and takes guidance from clients, is deciding who will represent which stakeholder perspective in a workspace. To focus discussion with us, we recommend imagining a local workspace; say a US County or two and [FRoI](../sroi/index.html) over 5-30 years. Our first consultation will then outline how we envisage relative nesting (parent, sibling, and child workspaces). 

More on [Scale(s)](../scales/index.html)
