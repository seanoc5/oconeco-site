...
rawTitle: "Human Dimensions :: Oconeco"
slug: "human-dimensions"
sourceUrl: "https://oconeco.webnode.page/human-dimensions/"
---
...
M-LA assumes this is what JR Hicks meant, at the end of [Value and Capital](https://archive.org/details/in.ernet.dli.2015.223876/page/n3/mode/2up), with "the system of economic relations we have been studying is nothing else but the form of a progressive economy" and ""we should do better to assume a good deal of variation in different people's elasticities of expectations". Something must interpret expectations enough to match production possibilities and consumer preferences; and willingness to invest to saving propensities. As in the World Bank's [pioneering 1995 wealth metrics](http://documents.worldbank.org/curated/en/378701468765915443/Monitoring-environmental-progress-a-report-on-work-in-progress), M-LA call that Social Infrastructure and considers it a factor of production apart from labor, or Human Resources. 
...
## [Social Infrastructure (SI)](/social-infrastructure-si/)
...
 More on [Social Infrastructure (SI)](/social-infrastructure-si/)
